<template>
    <section class="update-box">
        ...
        <section class="update-loading-box">
            <h4>{{updateProgress.name}}</h4>
            <h4 v-if="updateProgress.percent < 1">正在自动更新，请稍候</h4>
            <h4 v-else>正在启动安装</h4>
            <div class="loading-anim">
                <div class="border out"></div>
                <div class="border in"></div>
                <div class="border mid">{{Number.parseFloat((updateProgress.percent || 0.00001) * 100).toFixed(2)}}%</div>
                <div class="circle">
                    <span class="dot"></span>
                    <span class="dot"></span>
                    <span class="dot"></span>
